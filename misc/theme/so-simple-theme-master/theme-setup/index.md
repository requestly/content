...
So Simple Theme supports **link posts**, made famous by John Gruber. To activate just add `link: http://url-you-want-linked` to the post's YAML front matter and you're done. Here's an [example of a link post]({{ site.url }}{{ site.baseurl }}/articles/sample-link-post) if you need a visual.
...
![Twitter Card summary large image screenshot]({{ site.url }}{{ site.baseurl }}/images/twitter-card-summary-large-image.jpg)
